...
struct ManStory: View {
    ...
    private var pages: [Page] {
        [
            Page(imageName: "MaleStory1",
                 caption: "خلّنا نعلمك السنع من أوله",
                 showsPrimaryCTA: false),
            Page(imageName: "MaleStory2",
                 caption: "المجلس أمانة، عدّل كلامك وخلّك ذوق",
                 showsPrimaryCTA: false),
    ...
    private var captionArea: some View {
        if pages[index].showsPrimaryCTA == false {
        ...
        HStack(spacing: 12) {
            ...
            if isLast {
                Button(action: {
                    ...
                    .background(
                        Capsule()
                            .fill(Color(red: 0.62, green: 0.20, blue: 0.16)) // warm accent
